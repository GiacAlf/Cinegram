        ...
        <div class="col-sm-8 text-center">
            ...
            <div class="container-fluid bg-3 text-left"><br><br>
                ...
                <p><img src="https://via.placeholder.com/55" class="img-circle" height="55" width="55" style="width:7%" alt="Member">
                    <a href="#"> Member 1</a> <h6>follower: xxxx </h6><h6> risposte: yyyy</h6></p>
                <p><img src="https://via.placeholder.com/55" class="img-circle" height="55" width="55" style="width:7%" alt="Member">
                    <a href="#"> Member 2</a> <h6>follower: xxxx </h6><h6> risposte: yyyy</h6></p>
                <p><img src="https://via.placeholder.com/55" class="img-circle" height="55" width="55" style="width:7%" alt="Member">
                    <a href="#"> Member 3</a> <h6>follower: xxxx </h6><h6> risposte: yyyy</h6></p>
                <p><img src="https://via.placeholder.com/55" class="img-circle" height="55" width="55" style="width:7%" alt="Member">
                    <a href="#"> Member 4</a> <h6>follower: xxxx </h6><h6> risposte: yyyy</h6></p>
                <p><img src="https://via.placeholder.com/55" class="img-circle" height="55" width="55" style="width:7%" alt="Member">
                    <a href="#"> Member 5</a> <h6>follower: xxxx </h6><h6> risposte: yyyy</h6></p>
